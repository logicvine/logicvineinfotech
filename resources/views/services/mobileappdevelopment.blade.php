  ...
  <div class=" h-full !z-20 relative">
    <div class=" h-full relative z-50">
      <div class=" !transition-all h-full relative z-50 pt-28 py-16 sm:py-20 ">
        <div class="mx-auto max-2xl:max-w-7xl 2xl:px-24 3xl:px-36  h-full px-6 lg:px-8 w-full relative z-10 text-white">
          <div class="size-full">
    ...
    <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
             <div class="text-left rounded-xl bg-white py-8 px-11 transition-all duration-300 custom-cubic-bezier shadow-2xl">
                 ...
                 <div class="services-texts">
                     <h3 class="mb-4 text-xl font-semibold text-ellipsis line-clamp-1">Native App Development</h3>
                     <p class="text-light-muted mb-6 text-base text-ellipsis line-clamp-4">At Logic Vine Infotech, we specialize in React Native app development, creating high-performance, cross-platform mobile apps with a seamless user experience. Our solutions are designed to align with your brand and deliver efficient, scalable results for both iOS and Android platforms.</p>
             ...
             <div class="text-left rounded-xl bg-white py-8 px-11 transition-all duration-300 custom-cubic-bezier shadow-2xl">
                 ...
                 <div class="services-texts">
                     <h3 class="mb-4 text-xl font-semibold text-ellipsis line-clamp-1">Cross-Platform App Development
                    </h3>
                     <p class="text-light-muted mb-6 text-base text-ellipsis line-clamp-4">At Logic Vine Infotech, we specialize in cross-platform app development, delivering high-quality mobile applications that work seamlessly across both iOS and Android. Our solutions ensure a consistent user experience, helping you reach a wider audience with a single codebase.
                        .</p>
             ...
             <div class="text-left rounded-xl bg-white py-8 px-11 transition-all duration-300 custom-cubic-bezier shadow-2xl">
                 ...
                 <div class="services-texts">
                     <h3 class="mb-4 text-xl font-semibold text-ellipsis line-clamp-1">Mobile App Desgin Services</h3>
                     <p class="text-light-muted mb-6 text-base text-ellipsis line-clamp-4">At Logic Vine Infotech, we offer mobile app design services that focus on creating visually appealing, user-friendly interfaces. Our designs ensure a seamless and engaging user experience, perfectly aligning with your brand and optimizing app functionality across all devices.
             ...
             <div class="text-left rounded-xl bg-white py-8 px-11 transition-all duration-300 custom-cubic-bezier shadow-2xl">
                 ...
                 <div class="services-texts">
                     <h3 class="mb-4 text-xl font-semibold text-ellipsis line-clamp-1">Wearable App Development
                    </h3>
                     <p class="text-light-muted mb-6 text-base text-ellipsis line-clamp-4">At Logic Vine Infotech, we specialize in wearable app development, creating innovative and intuitive apps designed for smartwatches and other wearable devices. Our solutions deliver seamless integration, user-friendly interfaces, and real-time functionality to enhance the user experience on the go.</p>
