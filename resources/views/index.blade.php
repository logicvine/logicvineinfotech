                ...
                <div class="size-full flex flex-col justify-center">
                  ...
                  <p
                    ...
                    <label class="overflow-hidden flex flex-col ml-3 text-left *:text-nowrap w-max">
                      ...
                      <label class="mb-0 font-normal sm:text-xl 2xl:text-2xl 3xl:text-3xl text-base">Development
    ...
    <div class="max-w-7xl px-6 lg:px-8 w-full py-8 sm:py-14 lg:py-16 mx-auto">
      <div class="pb-7 sm:pb-10 text-center">
        ...
        <div class="md:text-xl text-base font-medium text-balance mt-5 text-white">
          ...
          platforms, our expert team delivers tailored solutions that drive growth, enhance user experiences, and ensure
          your success in the digital landscape. Let us bring your vision to life with our expertise and dedication to
          excellence.
        </div>
      </div>
      ...
      <div class="group pt-6 sm:pt-8 bg-white rounded-xl">
        <div class="flex items-center justify-center gap-4 *:text-nowrap ">
          <ul class="flex items-center  sm:justify-center overflow-y-auto gap-5 bg-zinc-200 p-1.5 rounded-md w-fit">
        ...
        <div class="rounded-xl">
          <input type="radio" name="insightsSection" id="webDevelopment" class="hidden peer/ass insights" checked />
          <div
            ...
            <div class="px-8 py-12">
              ...
              <p class="text-base mt-4 font-medium max-w-3xl text-theme1">
                At Logic Vine Infotech, we craft dynamic, responsive websites tailored to your business needs. Our web
                development solutions prioritize performance, security, and user experience, ensuring your online
        ...
        <div class="rounded-xl">
          ...
          <div
            class="py-5 text-sm md:text-base md:leading-8 peer-checked/ass:relative absolute peer-checked/ass:z-[1] -z-20 peer-checked/ass:opacity-100 opacity-0 inset-0 pointer-events-none peer-checked/ass:pointer-events-auto duration-300 delay-150">
            <div class="px-8 py-12">
              <a href="" class="text-semibold font-semibold text-4xl text-theme1">Mobile App Development</a>
              <p class="text-base mt-4 font-medium max-w-3xl text-theme1">
                At Logic Vine Infotech, we build high-performance mobile apps tailored for iOS and Android platforms.
                Our
                expert team ensures seamless user experiences, robust functionality, and scalable solutions to meet your
        ...
        <div class="rounded-xl">
          ...
          <div
            class="py-5 text-sm md:text-base md:leading-8 peer-checked/ass:relative absolute peer-checked/ass:z-[1] -z-20 peer-checked/ass:opacity-100 opacity-0 inset-0 pointer-events-none peer-checked/ass:pointer-events-auto duration-300 delay-150">
            <div class="px-8 py-12">
              <a href="" class="text-semibold font-semibold text-4xl text-theme1">Software Development</a>
              <p class="text-base mt-4 font-medium max-w-3xl text-theme1">
                At Logic Vine Infotech, we provide custom software development solutions tailored to meet your specific
                business needs. Our expert team delivers reliable, scalable, and efficient software that drives
        ...
        <div class="rounded-xl">
          ...
          <div
            class="py-5 text-sm md:text-base md:leading-8 peer-checked/ass:relative absolute peer-checked/ass:z-[1] -z-20 peer-checked/ass:opacity-100 opacity-0 inset-0 pointer-events-none peer-checked/ass:pointer-events-auto duration-300 delay-150">
            <div class="px-8 py-12">
              <a href="" class="text-semibold font-semibold text-4xl text-theme1">eCommerce Solution</a>
              <p class="text-base mt-4 font-medium max-w-3xl text-theme1">
                At Logic Vine Infotech, we deliver tailored eCommerce development solutions that boost online sales and
                enhance customer experiences. Our expert team builds secure, scalable platforms with user-friendly
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            "Commence on a digital journey with Logic Vine Infotech, where ideas unfold into cutting-edge solutions,
            shaping
            a dynamic future."
        ...
        <div
          ...
          <div
            ...
            Embark on a journey of innovation with Logic Vine Infotech, where creative ideas transform into cutting-edge
        ...
        <div
          ...
          <div
            class="font-normal 2xl:text-lg 3xl:text-2xl relative z-20 text-base text-slate-900 mt-4 text-center md:group-hover:text-white duration-300">
            Experience the expertise of Logic Vine Infotech, where our dedicated team turns your vision into reality
            with
        ...
        <div
          ...
          <div
            class="font-normal 2xl:text-lg 3xl:text-2xl relative z-20 text-base md:text-slate-900 text-white mt-4 text-center md:group-hover:text-white duration-300">
            Leverage the expertise of Logic Vine Infotech, where our skilled professionals deliver tailored digital
