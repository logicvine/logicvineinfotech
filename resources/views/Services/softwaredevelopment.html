              ...
              <div class=" text-center items-center ">
                <div class="size-full max-w-5xl flex flex-col justify-center">
                  ...
                  <div
                    ...
                    At Logic Vine Infotech, we provide tailored frontend development services that create visually
                    stunning and intuitive interfaces, ensuring an exceptional user experience that aligns perfectly
                    with your brand.
                  </div>
                  <button
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 py-12">
      <div class="lg:grid-cols-3 sm:grid-cols-2 grid gap-4">
        <div
          ...
          <p class="text-base mt-4">Tailored software development guarantees solutions that are specifically tailored to
        ...
        <div
          ...
          <p class="text-base mt-4">Custom software can be built to evolve with your company, easily meeting changing
        ...
        <div
          ...
          <p class="text-base mt-4">You have more control over security protocols with bespoke software, which lowers
        ...
        <div
          ...
          <p class="text-base mt-4">Bespoke software frequently turns out to be more cost-effective over time because of
        ...
        <div
          ...
          <p class="text-base mt-4">Our on-demand software solutions can help you thrive in this highly competitive
