<header
class="group-[]/nav:shadow-lg group-[]/nav:bg-white group-[]/nav:fixed group-[]/nav:animate-fixed-nav bg-transparent backdrop-blur-sm z-[999] overflowhidden fixed top-0 w-full">
        ...
        <li class="group relative">
          ...
          <div
            ...
            <ul class="*:py-1 *:px-4 *:text-base *:font-medium ">
              <li class="hover:text-yellow-500 border-b-2 relative before:absolute before:border-l-4 before:border-yellow-500 before:inset-0 before:translate-y-full overflow-hidden before:hover:translate-y-0 before:duration-500 before:pointer-events-none"><a href="{{ route('service.webdevelopment') }}">Web
                  Development</a></li>
              <li class="hover:text-yellow-500 border-b-2 relative before:absolute before:border-l-4 before:border-yellow-500 before:inset-0 before:translate-y-full overflow-hidden before:hover:translate-y-0 before:duration-500 before:pointer-events-none"><a href="{{ route('service.mobileappdevelopment') }}">Mobile
                  App Development</a></li>
              <li class="hover:text-yellow-500 border-b-2 relative before:absolute before:border-l-4 before:border-yellow-500 before:inset-0 before:translate-y-full overflow-hidden before:hover:translate-y-0 before:duration-500 before:pointer-events-none"><a href="{{ route('service.softwaredevelopment') }}">Software
                  Development</a></li>
              <li class="hover:text-yellow-500 border-b-2 relative before:absolute before:border-l-4 before:border-yellow-500 before:inset-0 before:translate-y-full overflow-hidden before:hover:translate-y-0 before:duration-500 before:pointer-events-none"><a href="{{ route('service.ecommerce') }}">eCommerce </a></li>
            </ul>
          </div>
