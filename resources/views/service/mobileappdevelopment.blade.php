    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-12 text-center sm:grid-cols-2 md:grid-cols-3 lg:gap-y-16">
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Native App Development
                </h3>
                <p class="mt-4 text-base text-gray-600">
                  At Logic Vine Infotech, we specialize in React Native app development, creating high-performance, cross-platform mobile apps with a seamless user experience. Our solutions are designed to align with your brand and deliver efficient, scalable results for both iOS and Android platforms.</p>
            </div>
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Cross-Platform App Development</h3>
                <p class="mt-4 text-base text-gray-600">
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Mobile App Desgin Services </h3>
                <p class="mt-4 text-base text-gray-600">
                  At Logic Vine Infotech, we offer mobile app design services that focus on creating visually appealing, user-friendly interfaces. Our designs ensure a seamless and engaging user experience, perfectly aligning with your brand and optimizing app functionality across all devices.
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Wearable App Development  </h3>
                <p class="mt-4 text-base text-gray-600">
                  At Logic Vine Infotech, we specialize in wearable app development, creating innovative and intuitive apps designed for smartwatches and other wearable devices. Our solutions deliver seamless integration, user-friendly interfaces, and real-time functionality to enhance the user experience on the go.
</p>
            </div>
