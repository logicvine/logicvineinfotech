                ...
                <div class="p-6.5">
                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                        <div class="w-full xl:w-1/2">
                            ...
                            <input name="cataegory" type="text" value="{{ $blog->cataegory }}"
                    ...
                    <div class="mb-6">
                        ...
                        <textarea rows="6" name="description" class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition">
                </div>
                @empty  
                @endforelse
@endsection
