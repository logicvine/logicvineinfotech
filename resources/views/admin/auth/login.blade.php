...
@section('content')
      <!-- ===== Main Content Start ===== -->
      <main>
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10 flex flex-col min-h-[100dvh] justify-center">
          <!-- ====== Form Layout Section Start -->
          <div class="flex items-center justify-center">
            <div class="flex flex-col gap-9 w-full max-w-sm">
              <!-- Sign In Form -->
              <div
                ...
                @csrf
                  <div class="p-6.5">
                    ...
                    <button
                      class="flex w-full justify-center rounded bg-primary p-3 font-medium text-gray hover:bg-opacity-90" type="submit">
                      Sign In
                    </button>
                  </div>
                </form>
